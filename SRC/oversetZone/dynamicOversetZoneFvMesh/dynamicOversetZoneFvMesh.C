...
bool Foam::dynamicOversetZoneFvMesh::updateAddressing() const
{
    ...
    if (debug)
    {
        Pout<< "dynamicOversetZoneFvMesh::update() : extended addressing from"
...
Foam::scalar Foam::dynamicOversetZoneFvMesh::cellAverage
(
...
void Foam::dynamicOversetZoneFvMesh::writeAgglomeration
(
...
Foam::dynamicOversetZoneFvMesh::dynamicOversetZoneFvMesh(const IOobject& io)
:
    dynamicMultiMotionSolverFvMesh(io),
    active_(false)
{
...
Foam::dynamicOversetZoneFvMesh::~dynamicOversetZoneFvZoneMesh()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

const Foam::lduAddressing& Foam::dynamicOversetZoneFvMesh::lduAddr() const
{
    if (!active_)
    {
...
Foam::lduInterfacePtrsList Foam::dynamicOversetZoneFvMesh::interfaces() const
{
    if (!active_)
    {
...
Foam::dynamicOversetZoneFvMesh::primitiveLduAddr() const
{
    if (lduPtr_.empty())
    {
...
Foam::word Foam::dynamicOversetZoneFvMesh::baseName(const word& name)
{
...
bool Foam::dynamicOversetZoneFvMesh::interpolateFields()
{
